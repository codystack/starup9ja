...
if (isset($_POST['register'])) {
  ...
  $state_of_origin         = mysqli_real_escape_string($con, $state_of_origin);
  $address                 = mysqli_real_escape_string($con, $address);
  $date_of_birth           = mysqli_real_escape_string($con, $date_of_birth);
  $age_category            = mysqli_real_escape_string($con, $age_category);
  $performance_category    = mysqli_real_escape_string($con, $performance_category);
  ...
  }else{ $query = "INSERT INTO users (first_name, last_name, email, phone_number, state_of_origin, address, date_of_birth, age_category, performance_category, regno) 
              VALUES('$first_name', '$last_name', '$email', '$phone_number', '$state_of_origin', '$address', '$date_of_birth', '$age_category', '$performance_category', '$regno')";
              if($query){
